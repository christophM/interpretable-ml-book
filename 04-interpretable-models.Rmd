...
Let's have a look at the effect realization for the rental bike count of one instance (= one day). Some features contribute unusually much to the predicted bike count: Temperature (`r X[i, 'temp']`) and the trend feature "days_since_2011", because this instance is from late 2011 (value = `r  X[i, 'days_since_2011']`).
