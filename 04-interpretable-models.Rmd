...
One big problem with linear models is the lack of interaction effects between features.
...
RuleFit fits a sparse linear model with (optionally) the original features and also new features which are decision rules, extracted from decision trees.
...
Then the decision rules are created and
