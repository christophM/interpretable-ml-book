...
Quite a lot!
But thanks to Lasso, only `r nrow(coefs)` of the `r nrow(coef(mod))` got a weight different from zero. 
...
Figure \@ref(rulefit-interaction) shows the feature interaction strength of each feature. 
...
TODO: Add partial dependence plots and refert to pdp chapter

TODO: Add cervical cancer example


### Guidelines


TODO: What is good about the method

TODO: What is not so good about the method

TODO: Tricks for using it.
