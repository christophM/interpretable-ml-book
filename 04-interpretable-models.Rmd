...
All of the interpretable model types explained in this book are interpretable on a modular level, with the exception of the k-nearest neighbours method.
...
kable(lm_summary_print[,c('Weight estimate', 'Std. Error')], digits = 1)
```
