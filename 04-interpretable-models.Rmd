...
Another tool is the interaction effects measurement which tells you how much the feature interact with each other.
TODO: Tell more about the intuition of the feature interaction measurement. 
...
Figure \@ref(fig:rulefit-interaction) shows the feature interaction strength of each feature. 
A feature that interacts a lot with other features has a high interaction strength. 

```{r rulefit-interaction, fig.cap = 'Feature importance measures for a RuleFit model predicting bike rentals. The most important features for the predictions were temperature and the time trend.'}
interact(mod, varnames = c('weathersit', 'temp'))
```
...
For numerical features, $\s_{jm}$ is usually a range in the feature values with lower and upper limit $x_{s_{jm},lower} < x_j < x_{s_{jm}, upper}}$.
...
TODO: Write about linear basis function

TODO: Write complete $F(X)$ With linear basis functions and rules and the optimization problem (Lasso)
...
**Step 3 (optional): Apply RuleFit interpretability tools**

TODO: Add feature importance measurement (mathematical definition)

TODO: Add interaction effects measurement (mathematical definition)

TODO: Mention random tree size?

TODO: Mention special loss for classification?

TODO: Add normalization of rules (with this 0.4 factor)


### Summary

TODO: Write a summary of the RuleFit method?
