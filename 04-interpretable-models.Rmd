...
logistic = function(x){1 / (1 + exp(-x)), out.width = '80%'}
...
Let's check the tumour size example again. But now instead of the linear regression model, we use the logistic regression model:
