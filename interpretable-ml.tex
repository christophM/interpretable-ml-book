...
{\centering \includegraphics[width=0.8\textwidth]{images/by-nc-sa} 
...
{\centering \includegraphics[width=0.8\textwidth]{images/programing-ml} 
...
{\centering \includegraphics[width=0.5\textwidth]{images/learner} 
...
{\centering \includegraphics[width=0.8\textwidth]{images/iml} 
...
{\centering \includegraphics[width=0.8\textwidth]{images/amazon-freq-bought-together} 
...
{\centering \includegraphics[width=0.8\textwidth]{images/doge-stuck} 
...
{\centering \includegraphics[width=0.8\textwidth]{images/learn-one-rule} 
...
{\centering \includegraphics[width=0.8\textwidth]{images/rulefit} 
...
{\centering \includegraphics[width=0.8\textwidth]{images/interaction-cervical-1} 
...
{\centering \includegraphics[width=0.8\textwidth]{images/interaction2-cervical-age-1} 
...
{\centering \includegraphics[width=0.8\textwidth]{images/unnamed-chunk-23-1} 
...
{\centering \includegraphics[width=0.8\textwidth]{images/handwritten-prototypes} 
...
{\centering \includegraphics[width=0.8\textwidth]{images/lime-images-package-example-1} 
...
{\centering \includegraphics[width=0.8\textwidth]{images/graph} 
...
{\centering \includegraphics[width=0.8\textwidth]{images/cfexp-nsgaII} 
...
{\centering \includegraphics[width=0.8\textwidth]{images/anchors-process} 
...
{\centering \includegraphics[width=0.8\textwidth]{images/shapley-instance} 
...
{\centering \includegraphics[width=0.8\textwidth]{images/shapley-instance-intervention} 
...
{\centering \includegraphics[width=0.8\textwidth]{images/shapley-coalitions} 
...
{\centering \includegraphics[width=0.8\textwidth]{images/shap-simplified-features} 
...
{\centering \includegraphics[width=0.8\textwidth]{images/shap-superpixel} 
...
{\centering \includegraphics[width=0.8\textwidth]{images/unnamed-chunk-44-1} 
...
{\centering \includegraphics[width=0.8\textwidth]{images/shap-importance} 
...
{\centering \includegraphics[width=0.8\textwidth]{images/shap-importance-extended} 
...
{\centering \includegraphics[width=0.8\textwidth]{images/shap-dependence} 
...
{\centering \includegraphics[width=0.8\textwidth]{images/shap-dependence-interaction} 
...
{\centering \includegraphics[width=0.8\textwidth]{images/shap-clustering} 
...
{\centering \includegraphics[width=0.8\textwidth]{images/cnn-features} 
...
{\centering \includegraphics[width=0.8\textwidth]{images/units} 
...
{\centering \includegraphics[width=0.8\textwidth]{images/a484} 
...
{\centering \includegraphics[width=0.8\textwidth]{images/activation-optim} 
...
{\centering \includegraphics[width=0.8\textwidth]{images/dissection-network} 
...
{\centering \includegraphics[width=0.8\textwidth]{images/dissection-dog-exemplary} 
...
{\centering \includegraphics[width=0.8\textwidth]{images/dissection-dogs} 
...
{\centering \includegraphics[width=0.8\textwidth]{images/vanilla} 
...
{\centering \includegraphics[width=0.8\textwidth]{images/original-images-classification} 
...
{\centering \includegraphics[width=0.8\textwidth]{images/smoothgrad} 
...
{\centering \includegraphics[width=0.8\textwidth]{images/tcav} 
...
{\centering \includegraphics[width=0.8\textwidth]{images/adversarial-ostrich} 
...
{\centering \includegraphics[width=0.8\textwidth]{images/cooks-analyzed-1} 
...
{\centering \includegraphics[width=0.8\textwidth]{images/influence-single-1} 
...
\textbf{bookdown}. Yihui Xie (2022). bookdown: Authoring Books and Technical Documents with R Markdown. R package version 0.25. \url{https://CRAN.R-project.org/package=bookdown}

\textbf{Cairo}. Simon Urbanek and Jeffrey Horner (2022). Cairo: R Graphics Device using Cairo Graphics Library for Creating
High-Quality Bitmap (PNG, JPEG, TIFF), Vector (PDF, SVG,
PostScript) and Display (X11 and Win32) Output. R package version 1.5-15. \url{https://CRAN.R-project.org/package=Cairo}

\textbf{caret}. Max Kuhn (2022). caret: Classification and Regression Training. R package version 6.0-91. \url{https://CRAN.R-project.org/package=caret}
...
\textbf{DT}. Yihui Xie, Joe Cheng and Xianying Tan (2022). DT: A Wrapper of the JavaScript Library `DataTables'. R package version 0.22. \url{https://CRAN.R-project.org/package=DT}
...
\textbf{grid}. R Core Team (2022). R: A language and environment for statistical computing. R Foundation for Statistical Computing, Vienna, Austria. URL \url{https://www.R-project.org/}.
...
\textbf{knitr}. Yihui Xie (2022). knitr: A General-Purpose Package for Dynamic Report Generation in R. R package version 1.38. \url{https://CRAN.R-project.org/package=knitr}
...
\textbf{mgcv}. Simon Wood (2022). mgcv: Mixed GAM Computation Vehicle with Automatic Smoothness
Estimation. R package version 1.8-39. \url{https://CRAN.R-project.org/package=mgcv}
...
\textbf{pre}. Marjolein Fokkema and Benjamin Christoffersen (2022). pre: Prediction Rule Ensembles. R package version 1.0.3. \url{https://CRAN.R-project.org/package=pre}
...
\textbf{rpart}. Terry Therneau and Beth Atkinson (2022). rpart: Recursive Partitioning and Regression Trees. R package version 4.1.16. \url{https://CRAN.R-project.org/package=rpart}
