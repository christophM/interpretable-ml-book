...
Grömping (2020)\footnote{Grömping, Ulrike. ``Model-Agnostic Effects Plots for Interpreting Machine Learning Models.'' Reports in Mathematics, Physics and Chemistry: Department II, Beuth University of Applied Sciences Berlin. Report 1/2020 (2020)} showed that in a linear models with two features with correlation between the features and an additional interaction term (\(f(x) = \beta_0 + \beta_1 x_1 + \beta_2 x_2 + beta_3 x_1 \cdot x_2\)), the first-order ALE plots do not show a straight line.
