...
Mail: \href{mailto:christoph.molnar.ai@gmail.com}{\nolinkurl{christoph.molnar.ai@gmail.com}}
...
\addcontentsline{toc}{subsection}{Lightning Never Strikes Twice}
...
\addcontentsline{toc}{subsection}{Trust Fall}
...
\addcontentsline{toc}{subsection}{Fermi's Paperclips}
...
\begin{tabular}{>{\raggedright\arraybackslash}p{14cm}|r}
\hline
CONTENT & CLASS\\
\hline
...
{\centering \includegraphics[width=\textwidth]{images/proto-critique2} 
...
An implementation of MMD-critic can be found here: \url{https://github.com/BeenKim/MMD-critic}.
...
\toprule
age & sex & job & amount & duration & \(o_2\) & \(o_3\) & \(o_3\) & \(\hat{f}(x')\)\tabularnewline
\midrule
\endhead
...
\textbf{Survived} & \textbf{true}\tabularnewline
\bottomrule
\end{longtable}
...
IF \texttt{SEX\ =\ female}\\
AND \texttt{Class\ =\ first}\\
THEN PREDICT \texttt{Survived\ =\ true}\\
WITH PRECISION \texttt{97\%}\\
AND COVERAGE \texttt{15\%}
...
\caption{Positive (left) and negative (right) activation of Inception V1 neuron 484 from layer mixed4d pre relu. While the neuron is maximally activated by wheels, something which seems to have eyes yields a negative activation. Code: \url{https://colab.research.google.com/github/tensorflow/lucid/blob/master/notebooks/feature-visualization/negative\_neurons.ipynb}}\label{fig:pos-neg}
\end{figure}
...
\tightlist
\item
  \url{https://www.its.ac.id/it/id/interpretable-machine-learning/} A complete translation by Hatma Suryotrisongko and Smart City \& Cybersecurity Laboratory, Information Technology, ITS.
\end{itemize}
...
\tightlist
\item
  \url{https://github.com/MingchaoZhu/InterpretableMLBook} Complete translations by \href{https://github.com/MingchaoZhu}{Mingchao Zhu}.
\item
  \url{https://blog.csdn.net/wizardforcel/article/details/98992150} Translation of most chapters, by CSDN, an online community of programmers.
\item
  \url{https://zhuanlan.zhihu.com/p/63408696} Translation of some chapters by 知乎. The website also includes questions and answers from various users.
\end{itemize}
...
\tightlist
\item
  \url{https://hacarus.github.io/interpretable-ml-book-ja/index.html} Complete translation by Ryuji Masui and team HACARUS.
\end{itemize}
...
\begin{itemize}
\item
  \url{https://tootouch.github.io/IML/taxonomy_of_interpretability_methods/} Complete Korean translation by \href{https://tootouch.github.io/}{TooTouch}
\item
  \url{https://subinium.github.io/IML/} Partial Korean translation by \href{https://subinium.github.io/}{An Subin}
\end{itemize}
...
\tightlist
\item
  \url{https://fedefliguer.github.io/AAI/} Full Spanish translation by \href{https://fedefliguer.github.io/}{Federico Fliguer}
\end{itemize}
...
\tightlist
\item
  \url{https://github.com/giangnguyen2412/InterpretableMLBook-Vietnamese} A complete translation by Giang Nguyen, Duy-Tung Nguyen, Hung-Quang Nguyen, Tri Le and Hoang Nguyen.
\end{itemize}
...
\addcontentsline{toc}{section}{R Packages Used}
...
\textbf{caret}. Max Kuhn (2021). caret: Classification and Regression Training. R package version 6.0-88. \url{https://CRAN.R-project.org/package=caret}

\textbf{data.table}. Matt Dowle and Arun Srinivasan (2021). data.table: Extension of \texttt{data.frame}. R package version 1.14.0. \url{https://CRAN.R-project.org/package=data.table}
...
\textbf{knitr}. Yihui Xie (2021). knitr: A General-Purpose Package for Dynamic Report Generation in R. R package version 1.34. \url{https://CRAN.R-project.org/package=knitr}
...
\textbf{lubridate}. Vitalie Spinu, Garrett Grolemund and Hadley Wickham (2021). lubridate: Make Dealing with Dates a Little Easier. R package version 1.7.10. \url{https://CRAN.R-project.org/package=lubridate}
...
\textbf{party}. Torsten Hothorn, Kurt Hornik, Carolin Strobl and Achim Zeileis (2021). party: A Laboratory for Recursive Partytioning. R package version 1.3-8. \url{https://CRAN.R-project.org/package=party}
...
\textbf{R.utils}. Henrik Bengtsson (2020). R.utils: Various Programming Utilities. R package version 2.10.1. \url{https://CRAN.R-project.org/package=R.utils}
...
\textbf{readr}. Hadley Wickham and Jim Hester (2021). readr: Read Rectangular Text Data. R package version 2.0.1. \url{https://CRAN.R-project.org/package=readr}
...
\textbf{shiny}. Winston Chang, Joe Cheng, JJ Allaire, Carson Sievert, Barret Schloerke, Yihui Xie, Jeff Allen, Jonathan McPherson, Alan Dipert and Barbara Borges (2021). shiny: Web Application Framework for R. R package version 1.7.0. \url{https://CRAN.R-project.org/package=shiny}
...
\textbf{tidyr}. Hadley Wickham (2021). tidyr: Tidy Messy Data. R package version 1.1.3. \url{https://CRAN.R-project.org/package=tidyr}
