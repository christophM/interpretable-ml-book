...
```{r ice-cervical}
cervical_subset = cervical[1:100, ]
...
pd1 = mlr::generatePartialDependenceData(mod, cervical_subset, 'Age', individual = TRUE, center = list(Age=14))
mlr::plotPartialDependence(pd1) + my_theme()
...
pd1 = mlr::generatePartialDependenceData(mod, cervical_subset[1:50,], 'Age', individual = TRUE, derivative = TRUE)
mlr::plotPartialDependence(pd1) + my_theme()
```
