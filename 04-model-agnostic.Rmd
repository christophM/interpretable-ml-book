...
A surrogate model is a simple, explainable model that explains a complex machine learning model. Models in [#simple] are viable candidates.
...
There are overlaps with []#viz-explanation]
