...
```{r dpd-cervical, fig.cap = 'The plots show the partial dependence plots of x1 and x2. x1 exhibits the V-shaped structure.'}
mod = train(makeLearner('classif.randomForest', predict.type = 'prob'), cervical_task)
...
```{r ice-cervical}
pd1 = mlr::generatePartialDependenceData(mod, cervical_task, 'Age', individual = TRUE)
...
```{r ice-cervical-centered}
pd1 = mlr::generatePartialDependenceData(mod, cervical_task, 'Age', individual = TRUE, center = list(Age=14))
mlr::plotPartialDependence(pd1) + my_theme()


pd1 = mlr::generatePartialDependenceData(mod, cervical_task, 'Smokes..years.', individual = TRUE, center = list(Smokes..years.=0), grid=20)
mlr::plotPartialDependence(pd1) + my_theme()
...
```{r ice-cervical-derivative}
pd1 = mlr::generatePartialDependenceData(mod, cervical_task, 'Age', individual = TRUE, derivative = TRUE)
mlr::plotPartialDependence(pd1) + my_theme()
```
