...
In the following chapters these three algorithm with it's variants are laid out. Not in detail, only the basics, because there are already a ton of books, videos, tutorials, papers and so on about them. We will focus on how to interpret the models.
