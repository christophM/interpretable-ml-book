...
```{r out.width=800}
knitr::include_graphics("shap-importance.png")
```
...
```{r}
knitr::include_graphics("shap-importance-extended.png")
```
...
```{r out.width=800}
knitr::include_graphics("shap-dependence.png")
```
...
```{r out.width=800}
knitr::include_graphics("shap-dependence-interaction.png")
```
...
knitr::include_graphics("shap-clustering.png")
```
