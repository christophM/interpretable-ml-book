...
```{r fig.cap = "SHAP summary plot. A short bill length contributes positively to P(Adelie). The summary plot also shows that bill length has the widest range of effects for the different penguins."}
...
```{r fig.cap = "SHAP feature dependence plot with interaction visualization. Here we see the dependence plot of bill length in interaction with the body mass. Especially for longer bills, the contribution of the bill length to P(Adelie) differes based on body mass."}
...
```{r, fig.cap="Stacked SHAP explanations clustered by explanation similarity. Each position on the x-axis is an instance of the data. Red SHAP values increase the prediction, blue values decrease it."}
