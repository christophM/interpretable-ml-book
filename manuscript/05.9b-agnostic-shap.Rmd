...
```{r shap-simplified-feature, fig.cap = "Function h_x() maps a coalition to a valid instance. For present features (z_j'=1) h_x maps to the feature value of x. For absent features (z_j'=0) h_x maps to the values of a randomly sampled data instance ", out.width=800}
...
TODO: Visualize h_x for image data.
...
<!-- Sampling trick -->
This Figure shows that the smallest and largest coalitions take up most of the weight.
