...
![LIME vs. Anchors -- A Toy Visualization. Inspired by figure from Ribeiro, Singh, and Guestrin (2018).](./images/anchors-visualization.png){#fig-lime-vs-anchors width=70%}
