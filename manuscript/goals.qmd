...
[^pneumonia]: A model predicted that patients who came to the emergency room with pneumonia and how had a history of asthma were less likely to die from pneumonia compared to patients without asthma. Despite the fact that asthma typically makes a patient more vulnerable to pneumonia not less. Thanks to using an interpretable model, it became clear that it's because asthma patients were treated earlier and more aggressively with antibiotics, so they were in fact less likely to develop severe pneumonia. The model learned the shortcut (asthma \Rightarrow lowered risk of dying from pneumonia), because it lacked features about the later treatment. 
