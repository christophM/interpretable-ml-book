...
While it's difficult to define interpretability mathematically, I like the definition by @biran2017explanation (also used by @miller2019explanation):
...
"The problem is that a single metric, such as classification accuracy, is an incomplete description of most real-world tasks." (Doshi-Velez and Kim 2017, [@doshi2017towards])
...
![Recommended products that are frequently bought together.](./images/amazon-freq-bought-together.png){#fig-recommended-products width=80%}
...
![Doge, our vacuum cleaner, got stuck. As an explanation for the accident, Doge told us that it needs to be on an even surface.](./images/doge-stuck.jpg){#fig-doge width=90%}
...
People focus more on abnormal causes to explain events (Kahneman and Tversky, 1981[@kahneman1982simulation]).
