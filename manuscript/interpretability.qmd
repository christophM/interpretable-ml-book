...
<!-- Interpretability -->
It's difficult to define interpretability (mathematically).
I like the definition  **Interpretability is the degree to which a human can understand the cause of a decision** from [@biran2017explanation] and also used by [@miller2019explanation].
Another good one is: 
