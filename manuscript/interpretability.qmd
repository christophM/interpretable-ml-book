...
These systems haven been in use for many years and it's clear that they work.
...
Ideally, models would only use causal features that are not be gameable.
...
"How was my loan application rejected?" can be turned into "Why was my loan application rejected?".
