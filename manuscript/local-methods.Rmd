...
In contrast to global methods, the notion of feature effect and importance are closer together for local methods.
For example the SHAP importance is just the absolute value of the normal SHAP values.

You will learn about the following local explanation techniques in this chapter:

* [Individual conditional expectation curves](#ice) are the building blocks for [partial dependence plots](#pdp) and describe how changing a feature changes a prediction.
