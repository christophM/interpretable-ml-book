...
There are many alternatives to compute feature importance, with many differences in definitions of importance.
I recommend the paper XXX by XXX 20XX as a great overview.

A big alternative are variance based feature importance measures.

Also the field of sensitivity analysis offers many measures.

Another loss-based alternative is to leave out the feature, and retrain the model.
