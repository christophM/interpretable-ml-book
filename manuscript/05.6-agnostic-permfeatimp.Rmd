...
And in fact, it did overfit the training data.
The mean absolute error for the training data is `r round(perf1,2)` and for the test data `r round(perf2,2)`, which is also the error of the best possible model that always predicts the mean outcome of 0 (mae  `r round(mean(abs(y2)),2)`).
...
Not for any other reason than that I had to choose one and using the training data needed a few lines less of code.
