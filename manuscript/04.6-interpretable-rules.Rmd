...
The OneR algorithm suggested by Holte (1993)[^oner] is one of the simplest rule induction algorithm.
...
We will use RIPPER to for the examples.
...
get.sbrl.rules = function(x) {
    x$rulenames = gsub(",", " & ", x$rulenames, fixed = TRUE)
