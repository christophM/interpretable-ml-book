...
<!-- TODO: -->
<!-- - Wait for permission to use images -->
...
Adversarial examples are instances that are designed to fool a machine learning model into giving a wrong prediction.
...
Szegedy et. al (2013)[^szegedy] used box-constrained L-BFGS optimization to find adversarial examples.
