...
The day trend feature goes from zero to large positive contributions, because the first day in the dataset (01.01.2011) has a very small trend effect and the estimated weight for this feature is positive (`r sprintf('%.2f', lm_summary_print['count_2days_before', 'Estimate'])`).
...
<!-- re-add 
For the value "`r df["workingday", "value"]`" of feature "`r df["workingday", "feature"]`", the effect is, `round(lm_summary_print[paste(df["workingday", "feature"], df["workingday", "value"], sep = ""), "Estimate"], 1)`.
-->
