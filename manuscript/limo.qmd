...
Various methods can be used to estimate the optimal weights.
...
The estimated number of bicycles is `r sprintf('%.1f', lm_summary_print['weatherBAD', 'Estimate'])` lower when it is bad (raining, snowing or stormy), compared to good weather -- again assuming that all other features do not change.
