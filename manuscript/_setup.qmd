...
penguins_rpart = randomForest(species ~ ., data = penguins_train)

penguins_rf_acc = mean(penguins_test$species == predict(penguins_rf, penguins_test))
penguins_rpart_acc = mean(penguins_test$species == predict(penguins_rpart, penguins_test))



library('MLmetrics')
penguins_rf_logloss = MultiLogLoss(y_pred = predict(penguins_rf, penguins_test, type="prob"), y_true = penguins_test$species)
penguins_rpart_logloss = MultiLogLoss(y_pred = predict(penguins_rpart, penguins_test, type="prob"), y_true = penguins_test$species)
```
