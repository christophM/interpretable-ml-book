...
Linear regression, logistic regression and the decision trees are commonly used interpretable models.

In the following chapters we will talk about these models.
Not in detail, only the basics, because there are already a ton of books, videos, tutorials, papers and other materials available.
