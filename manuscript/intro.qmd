...
But Interpretable ML or Explainable AI has really exploded as a field around 2015 [@molnar2020interpretable], and especially the subfield of model-agnostic interpretability, which offers methods that work for any model.
...
You don't have to read the book cover to cover, since Interpretable Machine Learning has a reference book character with most chapters describing one method.
