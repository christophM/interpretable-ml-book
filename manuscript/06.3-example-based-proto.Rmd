...
```{r mmd, fig.cap = "The squared maximum mean discrepancy measure (MMD2) for a dataset with two features and different selections of prototypes.", cache = TRUE}
set.seed(42)
n = 40
...
```{r witness, fig.cap = "Evaluations of the witness function at different points.", cache = TRUE, dependson = "mmd"}
