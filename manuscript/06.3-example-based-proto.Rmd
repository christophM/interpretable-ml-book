...
The small points are the data, the large points the prototypes and the large triangles the criticisms.
...
One solution is to select the number of protototypes and criticisms by measuring how much time humans have for the task of looking at the images, which depends on the particular application.
