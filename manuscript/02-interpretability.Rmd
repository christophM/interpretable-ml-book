...
But it can happen, because there is already the highly correlated apartment size feature and in a market where people prefer bigger rooms, a apartment with less rooms might be worth more than a apartment with more rooms when both have the same size. The weights only make sense in the context of the other features used in the model.
