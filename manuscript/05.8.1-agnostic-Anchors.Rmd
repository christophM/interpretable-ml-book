...
```{r fig.cap="Figure 1: LIME vs. Anchors - A Toy Visualization", out.width=800}
...
```{r fig.cap="Figure 2: The anchors algorithm’s components and their interrelations (simplified)", out.width=800}
