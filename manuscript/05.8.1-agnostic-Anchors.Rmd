...
saveRDS(bike.explainer, file = "../data/cached-anchors.RDS")

bike.explainer_edge = anchors(bike, mod, target = "target", tau = 1, batchSize = 1000, beams = 1, allowSuboptimalSteps = F)
saveRDS(bike.explainer_edge, file = "../data/cached-anchors-edge.RDS")
```
...
bike.explainer = readRDS("../data/cached-anchors.RDS")
...
bike.explainer_edge = readRDS("../data/cached-anchors-edge.RDS")
...
saveRDS(cancer.explainer, file = "../data/cached-anchors-cervical.RDS")
...
saveRDS(cancer.explainer.balanced, file = "../data/cached-anchors-cervical-balanced.RDS")
```
...
cancer.explainer = readRDS("../data/cached-anchors-cervical.RDS")
...
cancer.explainer.balanced = readRDS("../data/cached-anchors-cervical-balanced.RDS")
...
# TODO: Flip when the desired class is in the other direction
#w = clf.coef_
#b = clf.intercept_ 
...
#fs = rs.flipset.Flipset(x = X.iloc[i].get_values(), action_set = A, coefficients = w, intercept = b)
#fs.populate(enumeration_type = 'distinct_subsets', total_items = 45)
#fs.df.to_csv('recourse.csv')
