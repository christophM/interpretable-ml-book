...
bike.explanations = anchorsOnR::explain(bike.explained.instances, bike.explainer)
...
bike.explanations_edge = anchorsOnR::explain(bike.explained.instances_edge, bike.explainer_edge)
...
cancer.explanation = anchorsOnR::explain(cervical[c(1,7),], cancer.explainer)
...
cancer.explanation.balanced = anchorsOnR::explain(cervical.sampled.healthy[2:5,], cancer.explainer.balanced)
