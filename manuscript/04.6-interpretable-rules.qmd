...
```{r oner-penguin-confusion, eval=TRUE}
...
```{r jrip-penguins, include=TRUE, eval=TRUE}
...
```{r sbrl-penguins,results = "hide", eval = TRUE}
library("sbrl")
library("arules")
library("palmerpenguins")
