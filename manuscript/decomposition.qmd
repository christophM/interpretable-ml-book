...
```{r}
#| label: decomp-example
#| fig-cap: "Prediction surface of a function with two features $X_1$ and $X_2$."
...
```{r}
#| label: decomp-example-continued
#| fig-cap: "Decomposition of a function."
...
$$\hat{f}_1(x) = \int_{X_{-1}} \left( \hat{f}(x) - \hat{f}_0\right) d X_{-1}$$
