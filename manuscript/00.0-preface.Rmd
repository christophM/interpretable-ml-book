...
Eventually, I became interested in interpretable machine learning, and learning about it became my latest side project.
...
Given the success of machine learning and the importance of interpretability, I expected that there would be books or tutorials on these topics.
...
I received my bachelor and masters degree in statistics at the LMU Munich, Germany.
...
Then I try to explain the method intuitively without relying on too much mathematics.
...
For me, this is true, because each chapter contains critical discussions about advantages and disadvantages of the method.
This book is not an advertisement for the methods, but should help you decide whether a method works well for you or not.
...
This book has become a valuable resource for many people to learn about interpret machine learning models.
...
It am happy that many people can benefit from this book and become experts in model interpretation.
