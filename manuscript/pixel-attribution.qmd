...
![A saliency map in which pixels are colored by their contribution to the classification.](./images/vanilla.png)
...
![Images of a dog classified as greyhound, a ramen soup classified as soup bowl, and an octopus classified as eel.](./images/original-images-classification.png)
...
![Pixel attributions or saliency maps for the Vanilla Gradient method, SmoothGrad and Grad-CAM.](./images/smoothgrad.png)
