...
However, the sanity checks paper itself has found some criticism from @tomsett2020sanity with a paper called "Sanity checks for caliency metrics" (of course).
