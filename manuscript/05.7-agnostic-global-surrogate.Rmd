...
In our second example, we classify [penguin species](#penguins) with a random forest, again training a decision tree on the original dataset, but with the prediction of the random forest as outcome, instead of the real classes (Adelie, Chinstrap, Gentoo) from the data.
...
Might even be close enough to ditch the random forest altogether.
