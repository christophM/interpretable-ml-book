...
We analyze the interactions between features in a random forest trained to predict [penguin sex](#penguins), given body measurements.
...
We are interested in how this behaves by species.

```{r}
#| label: interaction-penguins-by-species
#| eval: true 
...
Body mass has the strongest interaction, so let's take a deeper look here:

```{r}
#| label: interaction2-penguins
#| eval: true 
