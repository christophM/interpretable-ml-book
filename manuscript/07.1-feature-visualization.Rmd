...
```{r fig.cap = "Example images from the Broden dataset. Figure originally from Bau \\& Zhou et. al (2017)."}
...
```{r, fig.cap = "Activation mask for inception\\_4e channel 750 which detects dogs with $IoU=0.203$. Figure originally from Bau \\& Zhou et. al (2017)."}
