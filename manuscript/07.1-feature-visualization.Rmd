...
But to find out just how interpretable the networks are, and especially individual units, we will look now closer at how the Network Dissection method works.
...
The authors of Network Dissection propose to label the concepts on a pixel level in the training data.
...
In total, over 60 000 images and over 1000 visual concepts.

TODO: Insert examples of Broden.
