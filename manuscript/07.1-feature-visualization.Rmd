...
We can also visualize individual neurons or layers of the fully connected layers.
Especially the neurons for the individual classes are interesting, because when we use those for feature visualization we find out which image maximizes this class the most.
...
- Sometimes not clear what the images mean. Use maximally activated training data to visualize in addition.
- Lack of diversity. An optimized image might only show a part of what activates the neural unit the most. Also training data can help here, because we see a broader spectrum.
