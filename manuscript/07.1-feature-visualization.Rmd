...
Is there some elegant way to automatically label each feature visualizations by what it is activated the most?
...
We learned in the [Feature Visualization chapter](#feature-visualization) that the network already learns somewhat disentangled representations of concepts in the units or layers.
...
TODO: Insert image with different intersections and how it is computed.
