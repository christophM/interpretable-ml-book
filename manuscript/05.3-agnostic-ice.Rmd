...
cervical_subset = cervical.data[cervical_subset_index, ]
cervical.task = makeClassifTask(data = cervical.data, target = "Biopsy")
...
bike.task = makeRegrTask(data = bike.data, target = "cnt")
...
bike.subset = bike.data[bike.subset.index,]
pd.data = mlr::generatePartialDependenceData(mod.bike, bike.subset, c('temp', 'hum', 'windspeed'), individual = TRUE, center = list(temp = min(bike.data$temp), hum = min(bike.data$hum), windspeed = min(bike.data$windspeed)))
