...
#### Example
Taking for example the cervical cancer ICE plot for age and centring the lines at the youngest observed age yields:
...
ice1 = Ice$new(predictor, feature = "temp", center.at = min(bike$temp))$plot() + my_theme()
ice2 = Ice$new(predictor, feature = "hum", center.at = min(bike$hum))$plot() + my_theme()
ice3 = Ice$new(predictor, feature = "windspeed", center.at = min(bike$windspeed))$plot() + my_theme()
