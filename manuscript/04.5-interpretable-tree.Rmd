...
## Decision Tree {#tree}
Linear regression models and logistic regression fail in situations where the relationship between features and outcome is nonlinear or where the features are interacting with each other.
...
The algorithm takes a feature and tries which cut-off point minimizes the sum of squares of y for a regression tasks or the Gini index of the class distribution of y for classification tasks.
