...
I trained 3 logistic regression models to predict [penguin sex](#penguins), using $\frac{2}{3}$ of the data for training and $\frac{1}{3}$ for computing the importance.  
