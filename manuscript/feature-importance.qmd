...
#| fig-cap: Permutation feature importance values for the penguin classification task. The interval indicates min and max importance from repeating the permutation 5 times, while dot represents the average PFI across multiple permutation.
plot(importance) +
