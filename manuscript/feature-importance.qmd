...
Just make sure to swap roles of $e_{\text{perm}}$ and $e_{\text{orig}}$ in the ratio/difference.
...
The dataset has $p = 100$ features; you set the number of non-zero weights to $5$.
