...
kable(ycomments[example_indices, c('CONTENT', 'CLASS')], booktabs = TRUE)  %>% kable_styling(position = "center")
...
kable(variations, row.names = FALSE, booktabs = TRUE)  %>% kable_styling(position = "center")
...
kable(explanations[c("case", "label_prob", "feature", "feature_weight")], booktabs = TRUE)  %>% kable_styling(position = "center")
