...
But usually you do not deal with the odds and interpret the $\beta$'s only as the odds ratios.
...
That is because the weight for that feature would not converge, but the optimal weight would be infinite.
