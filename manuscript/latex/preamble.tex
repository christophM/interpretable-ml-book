...
\captionsetup{
  font={normalsize, sf}, % Small font size and sans-serif style
  labelfont={bf}, % Bold and small for the label
  textfont={it}, % Italicize the text
  justification=raggedright, % Left-align the caption
  singlelinecheck=false % Prevent centering for single-line captions
}
