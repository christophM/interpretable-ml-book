...
It's even better when the counterfactual is likely according to the joint distribution of the data, for example, an apartment with 10 rooms and 20 m^2^ should not be regarded as counterfactual explanation. 
...
Anchors by Ribeiro et al. (2018) [@ribeiro2018anchors] are the opposite of counterfactuals, see chapter about [Scoped Rules (Anchors)](#anchors).
