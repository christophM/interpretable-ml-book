...
The Accumulated Local Effects (ALE) plot [^ALE] is an alternative to the [partial dependence plots](#pdp) and fixes the problem that they have when features are correlated.
