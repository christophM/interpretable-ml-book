...
For example, an ALE estimate of -2 at $x_j=3$ means that when the j-th feature has value 2, then the prediction is lower by 2 compared to the average prediction.
