...
TODO: List M-Plot as alternative to PDP?
...
TODO: Add first order effect plot ?
```{r ale-bike-2d, fig.cap = 'Accumulated Local Effects Plot for the second-order effect of windspeed and temperature on the predicted number of bike rentals'}
ALEPlot::ALEPlot(bike, mod, J = c("windspeed", "temp"), pred.fun = y.fun, K = 100)
```
