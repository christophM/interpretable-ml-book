...
```{r ale-penguins-1D, fig.cap = "ALE plots for the effect of bill length and body mass on predicted probability for each species. Short bills are associated with a higher probability for Adelie and a lower probability for Chinstrap. This relationship is reversed for bill lengths greater than 45 mm. The probability of Gentoo doesn't change much with bill length. Increasing body mass slightly increases P(Adelie) and P(Gentoo), but decreases P(Chinstrap).", fig.height = 4}
