...
An increase in a penguins bill length increases the odds of being a female vs a male penguin by a factor of `r coef.table['bill_length_mm', 'Odds ratio']`, when all other features remain the same.
