...
kableExtra::kbl(extract.glmnet.effects(l.mod$beta, max(which(n.features == 5))), col.names = "Weight", digits = 2, booktabs = TRUE, center = TRUE) %>% kable_styling(position = "center")
```
