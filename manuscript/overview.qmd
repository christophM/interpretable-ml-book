...
![Model-specific methods make complex models more interpretable by analyzing the models.](./images/specific-black-box.png){#fig-model-specific width=80% fig-align="center"}
