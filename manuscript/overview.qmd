...
![Short taxonomy of IML methods which also reflects the structure of the book.](./images/taxonomy.png){#fig-taxonomy width=70%}

<!-- image was created with Mermaid with the following code. Not using the mermaid chunk directly since it can cause problems when rendering -->
```{mermaid}
%%| eval: false
graph TD
...
![Interpretability by design means using ML algorithms that produce "inherently interpretable" models.](./images/interpretable-box.png){#fig-inherently width=80% fig-align="center"}
