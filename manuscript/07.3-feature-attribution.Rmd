...
The network in question is VGG-16 which was trained on the ImageNet data, and therefore able to distinguish more than 20,000 categories.
We start with the following images of XXX and XXX.
For all of these images, we will have a look at the top classification and create explanations for this top class.

CONTINUE HERE

TODO: Add all the original images here
And also their classification scores for the top class
...
```
TODO: Add interpretation (it's a mess here)
