...
- Roughly explain 3 different approaches:
    ...
    - Some other which is not GradCAM and still works. Integrated Gradients?
...
Grad-CAM is a localization technique.
...
$$L^c_{Grad-CAM} \in \mathbb{R}^{uxv} = ReLU\left(\sum_{k} \alpha_k^c A^k\right)$$
...
TODO: CONTINUE READING Grad-CAM paper at section 3
