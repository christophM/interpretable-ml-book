...
- The paper sanity checks for Saliency Maps [^sanity-checks] investigated whether a saliency method is insensitive to model and data, which would be highly undesirable. It turns out that many methods have this undesirable attributes. TODO: LIST
...
- Most methods only qualitively evaluated
- Danger of cherry picking explanations due to the many methods available.
  When someone shows you an explanation, how do you know that the metod was not picked because it showed a favourable explanation for the other party?
