...
- [Accumulated Local Effects](#ale) which is captured in another chapter
...
It make a lot of sense that the component for, say, feature $X_4$ should be independent of the interaction term between features $X_1$ and $X_2$.
