...
![Rule learned by searching a path through a decision tree. We end up with: If `location=good` and `size=big`, then `value=high`.](./images/learn-one-rule.png){#fig-learn-one-rule}
