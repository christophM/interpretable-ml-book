...
The posteriori probability distribution of lists (kind of meta, right?), makes it possible to say how likely a decision list is, given assumptions of shortness and how well the list fits the data.
...
2) Iteratively modify the list by adding, switching or removing rules, ensuring that the lists originate the distribution of lists and 
