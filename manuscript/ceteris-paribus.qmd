...
<!-- introduction -->
Ceteris paribus plots are the simplest analysis one can do, despite the complex-sounding Latin name, which stands for "other things equal" and means changing one feature but keeping the others untouched.
[^hate-latin]
