...
We look at the first penguin in the test dataset, a `r as.character(data_point_y)` `r as.character(data_point$species)` penguin with a bill length of `r data_point["bill_length_mm"]` millimeters.
