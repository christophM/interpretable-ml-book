...
But this is the perfect model-agnostic method to start the book with, since it teaches the basic principles of model-agnostic interpretation.
...
You can also create CP plots with any tool that can produce ICE plots, like ICEBox and iml, by simply providing a "dataset" that only contains the one data point you are interested in.
