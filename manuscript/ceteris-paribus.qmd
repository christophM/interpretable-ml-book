...
#| fig-cap: Ceteris paribus plot for bill length and one penguin. The line shows the predicted value for a particular penguin when changing the bill length. Increasing the bill length slightly increases P(female) for this penguin. The penguin's actual bill length is marked with a dot.
...
But this time we visualize it for all of the numerical features in @fig-whatif-bike.
