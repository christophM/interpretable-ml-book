...
```{r pdp-penguin, fig.cap = 'The longer the bill, the less likely it is to be an Adelie and the more likely it is to be a Chinstrap. A longer bill also slightly increases the probability of being a Gentoo. The effect of body mass is less pronounced: We see no effect of body mass on the Adelie probability (always around 50%). The probability of Chinstrap decreases slightly with increasing weight, while the probability for Gentoo increases.', dev.args = list(pointsize = 5.5), fig.height = 4}
