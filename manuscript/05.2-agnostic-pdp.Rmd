...
An ALE plot for feature $x_j$ is the acumulated integral of the expected gradient of the prediction over values of $x_j$.
...
TODO: Add to 2D examples the ALE plot version
