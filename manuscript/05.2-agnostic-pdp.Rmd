...
TODO: Describe what happens in missing rectangles.

Interpretation of the second-order ALE:
TODO: Explain 2D ALE plot: Is second-order effect

TODO: Explain ALE for 1 , features
TODO: Explain ALE for two categorical features
TODO: Explain ALE for mixed categorical and numerical features
TODO: Explain PDP for categorical features
TODO: Explain PDP for mixed numerical and categorical feature
TODO MAYBE: Give ALE plot it's own chapter
TODO: List M-Plot as alternative

TODO LATER: Replace ALEPlot::ALEPlot with iml::Partial


TODO: Add Advantages and Disadvantages of ALE plots  
- Disadvantage: how many numbers of intervals?
- Dis: They don't have accompanying ICE plots equivalent like PDPs
...
- Adv. ALE has O(n) and even if K goes to infinity, in reality its maximum n
...
ALE plots are a bit less intuitive, but still no dark magic.
...
- Partial dependence and ALE plots are **simple to implement**.
...
- Some PD and ALE plots don't include the **feature distribution**. 
...
A solution to this problem are ALEPlots[^ALE], which only average over close data points. 
- **Heterogenous effects might be hidden** because the ALE and PD plots only show the average over the observations. 
