...
Another way to capture heterogeneous effects is with regional PDP plots[^repid].
In the example above, suppose the data points with a positive association with the prediction share a common characteristic, such as another feature with a value above a certain threshold.
