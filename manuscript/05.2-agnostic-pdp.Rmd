...
```{r pdp-bike, fig.cap = 'Partial dependence plots for the bike count prediction model and the season. Unexpectedly all seasons show the same effect, only for "spring" the model predicts less bike rentals.'}
