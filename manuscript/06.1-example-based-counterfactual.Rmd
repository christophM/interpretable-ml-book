...
The multi-objective counterfactual explanation method by Dandl et al. is implemented in a [github repository](https://github.com/susanne-207/moc/tree/master/counterfactuals) but might be an own R package soon.
...
Karimi et al. (2019)[^karimi] also provided a Python implementation of their algorithm MACE in the [github repository](https://github.com/amirhk/mace). 
They translated necessary criteria for proper counterfactuals into logical formulae which needs to be satisfied. 
