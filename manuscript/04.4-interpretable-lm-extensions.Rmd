...
If you don't feel familiar enough with the standard linear regression model, I recommend reading the [chapter on linear regression models](#linear) first.
...
So here is a list of problem statement + the name of a solution that you can copy-paste into search:
