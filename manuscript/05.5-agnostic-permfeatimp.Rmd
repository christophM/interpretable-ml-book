...
We fit an decision tree model to predict [cervical cancer](#cervical).
...
```{r importance-cervical, fig.cap = "The importance for each of the features in predicting cervical cancer with an CART decision tree model.  The importance is the factor by which the error is increased compared to the original model error."}
library('mlr')
library('iml')
data("cervical")
