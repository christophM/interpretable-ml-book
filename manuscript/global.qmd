...
The surrogate model has an R-squared (variance explained) of `r rsq` on the test data which means it approximates the underlying black box behavior quite well, but not perfectly.
