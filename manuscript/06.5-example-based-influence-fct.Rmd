...
Before we start digging into these two approaches for finding influential instances, we will look intoß the difference between an outlier and an influential instance.
