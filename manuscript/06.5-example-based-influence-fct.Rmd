...
<!-- Let us again start at the left of the short sides of the chips, with the high negative gradient.  -->
...
<!-- Let us say the height of the chip is the loss, the coordinate along the back of the from back to neck is one parameter, and the coordinate of the saddle from left flank to right flank is the second parameter. -->
...
<!-- Let us call the position on the short side s and the position on the long side l: -->
