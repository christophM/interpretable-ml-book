...
$$I_{up,loss}(z,z_{test})=\left.\frac{d{}L(z_{test},\hat{\theta}_{\epsilon,z})}{d\epsilon}\right|_{\epsilon=0}=-\bigtriangledown_{\theta}L(z_{test},\hat{\theta})^T{}H^{-1}_{\hat{\theta}}\bigtriangledown_{\hat{\theta}}L(z_{test},\hat{\theta})$$
