...
"Far away" can be measured by for example the Euclidean distance.
...
TODO: Motivate use of disaggregated Cook's distance.
...
TODO: Explain the stochastic estimation of the Hessian instead of the conjugate gradients method, because that is what the authors use in the end.
TODO: Checkout if it is easy to use the code with bike data and small neural network.
