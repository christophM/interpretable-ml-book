...
kable(results, caption="Comparing bike rental model performance on test data with root mean squared error (RMSE) and mean absolute error (MAE).", row.names=FALSE)
```
...
kable(results, caption = "Comparison of model performance for penguin female vs. male classification.", row.names=FALSE)
```
