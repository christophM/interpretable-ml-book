...
One is called k-medoids, a clustering algorithm which is related to the k-means algorithm.
...
We want to test whether the distributions are different, based on their empirical distributions estimated by kernel densities.
...
Or the prototypes could have come from any clustering procedure, like k-medoids.
