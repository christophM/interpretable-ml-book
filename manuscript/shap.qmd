...
@fig-shows the SHAP feature importance for the random forest trained before for classifying penguins.
The bill length was the most important feature, changing the predicted probability for Adelie 33 pecentage points (0.33 on x-axis).
