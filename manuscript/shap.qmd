...
#| fig-cap: "SHAP values to explain the predicted probabilities for Adelie species for two penguins. The baseline -- the average predicted probability -- is 0.47. The first penguin has a high probability of being an Adelie penguin due to its small bill length. The second penguin is unlikely to be Adelie due to its large bill length and flipper length."
