...
Targeted at interpretability researchers or if your project requires you to go a bit deeper into interpretability, like having the requirement to evaluate the interpretations.

Evaluating approaches to interpretable machine learning is difficult due to a lack of ground truth.
Speaking as someone who did a PhD in model-agnostic interpretability, it can especially be annoying since there is this mindset in supervised machine learning that everything needs to benchmarks.
Which makes sense when you develop prediction models with available ground truth labels, but is difficult for interpretability research.
