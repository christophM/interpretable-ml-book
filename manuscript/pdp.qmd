...
This time we fit a random forest to classify penguin sex based on body measurements.
...
pdp = FeatureEffect$new(pred.penguins, "bill_depth_mm", method = "pdp")
...
#| fig.cap: PDP by penguin species. A more nuanced interpretation emerges. For Adelie, more weight means less likely to be female. For Chinstrap the weight doesn't affect the probability very much. Gentoo penguins are in general heavier, but also show the "males are more heavy" pattern.
#| fig.height: 4
