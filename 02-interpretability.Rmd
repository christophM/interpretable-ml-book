...
If you don't want to read the Chapter, but want the insights translated for building good explanation frameworks for machine learning:
...
- Good explanations are contrastive. Humans don't want a complete explanation for a prediction but rather compare what the difference were to another instance's prediction (could also be a fictive one).
- Good explanations focus on abnormal causes. If
- Fidelity
- Generality
<!--TODO: Expand each point with an example and implications for building explanation systems -->
...
@miller2017explanation's major findings about explanations are:
...
Scenario 2:
Again, the student did not study for the test.
But in this scenario is a different teacher who tests the students almost never.
In this case though, the teacher tests the unlucky student.
Why did the student fail?
Because, unfortunately for the student, the teacher decided to test.
The teacher testing the student was very



Also relevant, but minor points for good explanations:
- They have to be true. If they are not true, people probably don't accept them. But this is not the most important factor for a 'good' explanation
