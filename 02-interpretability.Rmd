...
Throughout the book, I will use this rather simple, yet elegant definition from \citet{miller2017explanation}: Machine learning interpretability is the degree to which a human can understand a model's decision. So the higher the interpretability of a model, the easier it is for someone to comprehend why certain decisions (read: predictions) where made. Comparing two models, the one that is easier to understand for a human, is the one that is mor interetable. I will be using both the terms interpretable and explainable equally. 
