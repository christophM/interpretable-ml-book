...
Have a glance at Figure \@ref(fig:dpd-cervical) to get some intuition before diving into the theory of partial dependencies.
...
Figure \@ref(fig:dpd-bike) shows the influence of the weather features on the predicted bike counts.
...
Figure \@ref(fig:dpd-cervical) shows a partial dependence plot example for cervical cancer classification (see Chapter \@ref(cervical-data) for the data).
...
Figure \@ref(fig:dpd-cervical-2d) shows an example of a partial dependence plot with two features.
