...
\caption{Logistic regression successfully finds the correct decision boundary to distinguish between malignant (class=1) and benign (class=0) tumours dependent on it's size in this illustrative example. The blue line is the logistic function shifted and squeezed so that it fits the data.}\label{fig:logistic-class-threshold}
\end{figure}
