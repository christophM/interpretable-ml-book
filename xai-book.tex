...
\{\centering \includegraphics{xai-book_files/figure-latex/linear-weights-plot-1}
...
{\centering \includegraphics{xai-book_files/figure-latex/linear-effects-1} 
...
{\centering \includegraphics{xai-book_files/figure-latex/linear-effects-single-1} 
...
\section{Sparse linear models}\label{lasso}
