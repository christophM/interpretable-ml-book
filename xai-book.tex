...
and on single words or superpixels. In the case of tabular data, LIME
creates new samples by pertubing each feature individually, by drawing
...
center, which is problematic. But it increases the likelihood that the
