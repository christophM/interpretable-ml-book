...
\section{Linear Model}\label{limo}
...
situation feature the estimated \(\beta\) signifies the difference
between good and rainy/storm/snowy weather, for temperature it signifies
only an increase of 1 degree Celsius. You can improve the comparison by
scaling the features to mean zero and standard deviation of one before
fitting the linear model, to make the estimated weights comparable.
...
{\centering \includegraphics[width=0.8\linewidth]{xai-book_files/figure-latex/linear-effects-1} 
...
{\centering \includegraphics[width=0.8\linewidth]{xai-book_files/figure-latex/linear-effects-single-1} 
...
vector, leads to a penalisation of large \(\boldsymbol{\beta}\)-values.
Since the L1-norm is used, many of the weights for the features will get
an estimate of 0 and the others are shrunk. The parameter \(\lambda\)
...
{\centering \includegraphics[width=0.8\linewidth]{xai-book_files/figure-latex/linear-class-threshold-1} 
...
{\centering \includegraphics[width=0.8\linewidth]{xai-book_files/figure-latex/logistic-function-1} 
...
{\centering \includegraphics[width=0.8\linewidth]{xai-book_files/figure-latex/logistic-class-threshold-1} 
...
{\centering \includegraphics[width=0.8\linewidth]{xai-book_files/figure-latex/tree-artificial-1} 
...
{\centering \includegraphics[width=0.8\linewidth]{xai-book_files/figure-latex/tree-example-1} 
...
{\centering \includegraphics[width=0.8\linewidth]{xai-book_files/figure-latex/dpd-bike-1} 
...
{\centering \includegraphics[width=0.8\linewidth]{xai-book_files/figure-latex/dpd-cervical-1} 
...
{\centering \includegraphics[width=0.8\linewidth]{xai-book_files/figure-latex/dpd-cervical-2d-1} 
...
{\centering \includegraphics[width=0.8\linewidth]{xai-book_files/figure-latex/ice-cervical-1} 
...
{\centering \includegraphics[width=0.8\linewidth]{xai-book_files/figure-latex/ice-bike-1} 
...
{\centering \includegraphics[width=0.8\linewidth]{xai-book_files/figure-latex/ice-cervical-centered-1} 
...
{\centering \includegraphics[width=0.8\linewidth]{xai-book_files/figure-latex/ice-bike-centered-1} 
...
{\centering \includegraphics[width=0.8\linewidth]{xai-book_files/figure-latex/ice-cervical-derivative-1} 
...
{\centering \includegraphics[width=0.8\linewidth]{xai-book_files/figure-latex/ice-bike-derivative-1} 
...
{\centering \includegraphics[width=0.8\linewidth]{xai-book_files/figure-latex/lime-fitting-1} 
...
{\centering \includegraphics[width=0.8\linewidth]{xai-book_files/figure-latex/lime-tabular-example-explain-plot-1-1} 
...
{\centering \includegraphics[width=0.8\linewidth]{xai-book_files/figure-latex/lime-tabular-example-explain-plot-2-1} 

}

\caption{LIME explanations for two instances of the bike rental classification task. This time numerical features were turned into categorical features by binning them.}\label{fig:lime-tabular-example-explain-plot-2}
\end{figure}
...
{\centering \includegraphics[width=0.8\linewidth]{xai-book_files/figure-latex/lime-text-explanations-1} 
